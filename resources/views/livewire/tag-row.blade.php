<tr class="text-left text-slate-900">
    <td class="pl-6 py-4 pr-3 font-medium">{{ $tag->name }}</td>
    ...
    <td class="pl-4 py-4 text-right pr-6 flex gap-2 justify-end">
        <x-menu>
            ...
            <x-menu.items>
                <x-dialog wire:model="tagEditModal">
                    <x-dialog.open>
                        <x-menu.close>
                            <x-menu.item>
                    ...
                    <x-dialog.panel>
                        <form wire:submit="save" class="flex flex-col gap-4">
                            <h2 class="text-3xl font-bold mb-1">Edit {{$tag->name}}</h2>
                ...
                <x-dialog>
                    ...
                    <x-dialog.panel>
                        <div class="flex flex-col gap-6" x-data="{ confirmation: '' }">
                            ...
                            <h2 class="text-lg text-slate-700">This operation is permanent and cannot be reversed. This
                                tag will be deleted forever.</h2>
