    ...
    >
        ...
        <div class="relative min-h-full flex justify-center items-end sm:items-center p-0 sm:p-4">
            <div
                x-dialog:panel
                x-transition.in
                class="relative max-w-5xl w-full bg-white rounded-t-xl sm:rounded-b-xl shadow-lg overflow-hidden"
            >
                ...
                <div class="absolute top-0 right-0 pt-4 pr-4">
                    <button type="button" x-on:click="$dialog.close()" class="bg-red-500 rounded-full p-2 text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">
